      ...
      <button
        ...
        className={cn(
          'inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
          {
            ...
            'bg-zinc-800 text-white hover:bg-zinc-700 border border-zinc-700 focus:ring-zinc-500':
              variant === 'secondary',
            'hover:bg-zinc-800 text-zinc-300 hover:text-white focus:ring-zinc-500': variant === 'ghost',
